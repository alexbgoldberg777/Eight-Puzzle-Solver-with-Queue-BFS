...
public class EightPuzzle implements GenericGame<List<Integer>> {
	 ...
	 * It uses the Solver class and its BFSSolve method to find the solution to the game with a Queue-based Breadth First Search.
	 */
	public static void main(String[] args) {
		EightPuzzle e = new EightPuzzle(Arrays.asList(new Integer[] { 1, 2, 3, 4, 0, 6, 7, 5, 8 }));

		List<List<Integer>> r = new Solver<List<Integer>>(e).BFSSolve();
